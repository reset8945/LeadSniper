...
[English](https://www.npmjs.com/package/leadsniper) | 中文
...
安装器会自动识别 macOS Apple Silicon 或 Windows x64，检测本机已经安装的
Agent，并询问要把 LeadSniper 安装到哪里。
...
<img src="https://github.com/reset8945/LeadSniper/releases/download/v0.1.0/wechat_group_qr.png" alt="LeadSniper 项目交流群二维码" width="280">

[打开二维码或查看 v0.1.0 Release](https://github.com/reset8945/LeadSniper/releases/tag/v0.1.0)
